...
|2006/05/13|AmaterasUML|1.1.2|**Common**<br>- Enable to hide icons.<br>- Enable to change background/foreground color.<br><br> **Class Diagram** <br>- Enable to align diagram element.<br>- Add new connection router.<br> **Sequence Diagram** <br>- Change presentation of instance.<br>- Add Sequence API and sample plugin.<br> **Java support** <br>- Enable to open Java editor from class diagram.<br><br> **Limitation** <br>- Sorry, Sequence diagram editor can't edit *.sqd files created by older version. <br>|
