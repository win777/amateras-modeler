...
|2006/04/22|AmaterasUML|1.1.1|**Add drag-and-drop**<br>- both class and sequence<br>- drap Java file in package exploler view.<br><br> **Enable to delete and create Return message.** <br>- Auto return message creation swtich in AmaterasUML preference<br><br> **Add code completion feature to edit message.** <br>|
